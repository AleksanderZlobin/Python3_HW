    ...
    while True:
        ...
        match choice:
            ...
            case 4:
                ...
                view.print_message(text.contact_action(
                    new_contact[0], text.operation[0]))
            case 5:
                search_contact(pb)
            case 6:
                if search_contact(pb):
                    ...
                    view.print_message(
                        text.contact_action(name, text.operation[1]))
            case 7:
                if search_contact(pb):
                    c_id = int(view.input_request(text.input_del_contact_id))
                    name = pb.delete_contact(c_id)
                    view.print_message(
                        text.contact_action(name, text.operation[2]))
            case 8:
