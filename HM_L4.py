...
# print(f_set := set(randint(1, 20) for _ in range(
#     int(input('Введите количество элементов первого множества: ')))))
# print(s_set := set(randint(1, 20) for _ in range(
#     int(input('Введите количество элементов второго множества: ')))), end='\n\n')
# _intersection = sorted(f_set.intersection(s_set))
# print(*_intersection, end='\n\n')

print(f_list := [randint(1, 20) for _ in range(
    int(input('Введите количество элементов первого набора чисел: ')))])
print(s_list := [randint(1, 20) for _ in range(
    int(input('Введите количество элементов второго набора чисел: ')))], end='\n\n')
_intersection = sorted(set(f_list).intersection(set(s_list)))
print(*_intersection)
...
print(value := [randint(1, 30)
      for i in range(int(input('Введите количество кустов: ')))])

max_sum = 0

for i in range(len(value)):
    if max_sum < value[i] + value[(i+1) % len(value)] + value[(i+2) % len(value)]:
        max_sum = value[i] + value[(i+1) % len(value)] + \
            value[(i+2) % len(value)]
